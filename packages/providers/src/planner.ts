 ...
 * alterou o repositorio e o diff conferido pelo control plane depois da chamada (ADR-0016),
...
/**
 * Adapter da porta `MissionPlanner` (ADR-0016) sobre CLI local ja autenticada por
...
export class LocalCliMissionPlanner implements MissionPlanner {
  ...
  #spawn(request: PlanningRequest): Promise<LocalAgentProcess> {
    ...
    return this.#runtime.spawn(spec, {
      // Raiz de LEITURA, nao workspace: sem lease, sem branch, sem commit base (ADR-0016).
