 ...
 * arrendar. I8 e I11 nao se aplicam aqui: eles falam de tentativa (ADR-0013).
 */
 ...
 * `apiVersion` nem escolher onde o artefato mora (ADR-0013).
 *
 ...
 * tentativa e workspace — os tres inexistem antes da missao nascer (ADR-0013).
 *
